    ...
    <footer className="border-t border-border bg-background">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h4 className="font-mono text-xs font-bold tracking-widest text-muted-foreground uppercase">QUICK LINKS</h4>
            <ul className="space-y-2 text-sm">
              <li>
                <a href="/" className="text-foreground hover:text-accent transition-colors font-mono">
                  / HOME
                </a>
              </li>
              <li>
                <a href="/about" className="text-foreground hover:text-accent transition-colors font-mono">
                  / ABOUT
                </a>
              </li>
              <li>
                <a href="/blog" className="text-foreground hover:text-accent transition-colors font-mono">
                  / BLOG
                </a>
              </li>
            </ul>
