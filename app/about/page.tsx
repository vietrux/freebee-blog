  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:py-16 sm:px-6 lg:px-8">
      ...
      <div className="mb-8 sm:mb-12 border-b border-border pb-6 sm:pb-8">
        <span className="section-label block mb-3 sm:mb-4">[ ABOUT ]</span>
        <h1 className="font-mono text-2xl sm:text-4xl font-bold tracking-tight text-foreground mb-3 sm:mb-4">
          ABOUT ME
        </h1>
        <p className="text-base sm:text-xl text-muted-foreground font-mono">
      ...
      {/* Skills Section */}
      <section className="mb-8 sm:mb-12">
        <span className="section-label block mb-3 sm:mb-4">[ SKILLS ]</span>
        <h2 className="font-mono text-xl sm:text-2xl font-bold text-foreground mb-4 sm:mb-6">
          TECHNOLOGIES I WORK WITH
        </h2>
        <div className="grid gap-3 sm:gap-4 grid-cols-2 lg:grid-cols-4 bg-white">
          {[
            {
              category: 'FRONTEND',
            ...
            <div key={group.category} className="bg-background p-4 sm:p-6 border border-border">
              <h3 className="font-mono text-[10px] sm:text-xs font-bold tracking-widest text-muted-foreground uppercase mb-3 sm:mb-4">
                {group.category}
              </h3>
              <ul className="space-y-1.5 sm:space-y-2">
                {group.skills.map((skill) => (
                  <li key={skill} className="flex items-center text-foreground font-mono text-xs sm:text-sm">
                    <span className="text-success mr-1.5 sm:mr-2">✓</span>
                    {skill}
                  </li>
                ))}
              </ul>
      ...
      {/* Contact Section */}
      {/* Contact Section */}
      <section className="card-featured p-4 sm:p-8">
        <span className="text-[10px] sm:text-xs font-mono font-bold tracking-widest uppercase text-accent block mb-3 sm:mb-4">
          [ CONNECT ]
        </span>
        <h2 className="font-mono text-xl sm:text-2xl font-bold mb-3 sm:mb-4">
          LET'S CONNECT
        </h2>
        ...
        <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-2 sm:gap-3">
          <a
            ...
            className="inline-flex items-center justify-center px-3 sm:px-4 py-2 border border-white text-white font-mono text-xs sm:text-sm hover:bg-white hover:text-black transition-all"
          >
            <svg className="mr-1.5 sm:mr-2 h-3 w-3 sm:h-4 sm:w-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a
            ...
            className="inline-flex items-center justify-center px-3 sm:px-4 py-2 border border-accent text-accent font-mono text-xs sm:text-sm hover:bg-accent hover:text-black transition-all"
          >
            <svg className="mr-1.5 sm:mr-2 h-3 w-3 sm:h-4 sm:w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
